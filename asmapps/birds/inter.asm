...
testut
	btfss	INTCON,INTF	; check the ext interrupt flag
	goto	chknxt		; no, check next int condition
	bcf	INTCON,INTF	; clear the interrupt bit
	banksel	PORTB
	movf	PORTB,w
	banksel	birdinp
	andwf	birdinp,f	; 0 means a hit, main prog will reset 
