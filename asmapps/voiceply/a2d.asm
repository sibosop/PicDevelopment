...
ctestlp
	...
	btfsc	cmask,NumChans	; num chans bit, we've hit the end
	return			; so return
...
sendval
	...
	movf	a2dvals,w	; get the first a/d val
	subwf	a2dvals+1,w	; test it against the second
	btfss	STATUS,C	; carry set if 0 > 1
	goto	lessthan
	banksel	PORTA
	btfss	PORTA,4
	goto	setLed
