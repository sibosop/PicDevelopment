...
USRFILE	UDATA	
	constant	NumTimers = 3

timers		res	(NumTimers*2)	; 2 bytes for each timer
timermask	res	1
...
inittimers	
	global	inittimers
	banksel	tmp1
	clrf	tmp1			; set the timer mask to timer 0
	bsf	tmp1,0			
...
initloop
	...
	btfss	tmp1,NumTimers		; bit goes into carry when done
...
nexttimer
	...
	slf	tmp1,f			; shift mask to next timer
	btfss	tmp1,NumTimers		; mask went into carry 
